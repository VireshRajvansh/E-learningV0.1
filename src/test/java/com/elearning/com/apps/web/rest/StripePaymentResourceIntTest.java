...
public class StripePaymentResourceIntTest {
    ...
    public void setup() {
        ...
        final StripePaymentResource stripePaymentResource = new StripePaymentResource(stripePaymentRepository);
    ...
    public void createStripePayment() throws Exception {
        ...
        restStripePaymentMockMvc.perform(post("/api/stripe-payments")
            ...
            .content(TestUtil.convertObjectToJsonBytes(stripePayment)))
    ...
    public void updateStripePayment() throws Exception {
        ...
        StripePayment updatedStripePayment = stripePaymentRepository.findById(stripePayment.getId()).get();
        ...
        restStripePaymentMockMvc.perform(put("/api/stripe-payments")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedStripePayment)))
            .andExpect(status().isOk());
