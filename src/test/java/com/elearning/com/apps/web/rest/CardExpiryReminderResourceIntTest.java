...
public class CardExpiryReminderResourceIntTest {
    ...
    public void setup() {
        ...
        final CardExpiryReminderResource cardExpiryReminderResource = new CardExpiryReminderResource(cardExpiryReminderRepository);
    ...
    public void createCardExpiryReminder() throws Exception {
        ...
        restCardExpiryReminderMockMvc.perform(post("/api/card-expiry-reminders")
            ...
            .content(TestUtil.convertObjectToJsonBytes(cardExpiryReminder)))
    ...
    public void updateCardExpiryReminder() throws Exception {
        ...
        CardExpiryReminder updatedCardExpiryReminder = cardExpiryReminderRepository.findById(cardExpiryReminder.getId()).get();
        ...
        restCardExpiryReminderMockMvc.perform(put("/api/card-expiry-reminders")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedCardExpiryReminder)))
            .andExpect(status().isOk());
