...
import static com.elearning.com.apps.web.rest.TestUtil.sameInstant;
...
public class StripeCustomerResourceIntTest {
    ...
    public void setup() {
        ...
        final StripeCustomerResource stripeCustomerResource = new StripeCustomerResource(stripeCustomerRepository);
    ...
    public void createStripeCustomer() throws Exception {
        ...
        restStripeCustomerMockMvc.perform(post("/api/stripe-customers")
            ...
            .content(TestUtil.convertObjectToJsonBytes(stripeCustomer)))
    ...
    public void updateStripeCustomer() throws Exception {
        ...
        StripeCustomer updatedStripeCustomer = stripeCustomerRepository.findById(stripeCustomer.getId()).get();
        ...
        restStripeCustomerMockMvc.perform(put("/api/stripe-customers")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedStripeCustomer)))
            .andExpect(status().isOk());
