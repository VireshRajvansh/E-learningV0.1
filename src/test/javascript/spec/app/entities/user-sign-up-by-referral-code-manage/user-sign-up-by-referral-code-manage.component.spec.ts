...
import { UserSignUpByReferralCodeManageComponent } from 'app/entities/user-sign-up-by-referral-code-manage/user-sign-up-by-referral-code-manage.component';
    ...
    describe('UserSignUpByReferralCodeManage Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new UserSignUpByReferralCodeManage(123)],
                        headers
                    })
                )
            );
