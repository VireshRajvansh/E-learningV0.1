...
import { EducationCollegeManageComponent } from 'app/entities/education-college-manage/education-college-manage.component';
    ...
    describe('EducationCollegeManage Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new EducationCollegeManage(123)],
                        headers
                    })
                )
            );
