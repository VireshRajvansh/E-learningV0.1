...
import { CardExpiryReminderManageComponent } from 'app/entities/card-expiry-reminder-manage/card-expiry-reminder-manage.component';
    ...
    describe('CardExpiryReminderManage Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new CardExpiryReminderManage(123)],
                        headers
                    })
                )
            );
