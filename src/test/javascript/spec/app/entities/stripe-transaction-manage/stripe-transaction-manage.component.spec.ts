...
import { StripeTransactionManageComponent } from 'app/entities/stripe-transaction-manage/stripe-transaction-manage.component';
    ...
    describe('StripeTransactionManage Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new StripeTransactionManage(123)],
                        headers
                    })
                )
            );
