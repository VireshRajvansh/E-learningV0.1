...
export class StateManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.stateService
            ...
            .subscribe(
                (res: HttpResponse<IStateManage[]>) => this.paginateStates(res.body, res.headers),
    ...
    trackId(index: number, item: IStateManage) {
        return item.id;
    }
    ...
    private paginateStates(data: IStateManage[], headers: HttpHeaders) {
