...
export class GalleryManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.galleryService
            ...
            .subscribe(
                (res: HttpResponse<IGalleryManage[]>) => this.paginateGalleries(res.body, res.headers),
    ...
    trackId(index: number, item: IGalleryManage) {
        return item.id;
    }
    ...
    private paginateGalleries(data: IGalleryManage[], headers: HttpHeaders) {
