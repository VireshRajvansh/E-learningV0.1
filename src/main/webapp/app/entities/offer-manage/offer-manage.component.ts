...
export class OfferManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.offerService
            ...
            .subscribe(
                (res: HttpResponse<IOfferManage[]>) => this.paginateOffers(res.body, res.headers),
    ...
    trackId(index: number, item: IOfferManage) {
        return item.id;
    }
    ...
    private paginateOffers(data: IOfferManage[], headers: HttpHeaders) {
