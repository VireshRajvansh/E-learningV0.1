...
export class CourseManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.courseService
            ...
            .subscribe(
                (res: HttpResponse<ICourseManage[]>) => this.paginateCourses(res.body, res.headers),
    ...
    trackId(index: number, item: ICourseManage) {
        return item.id;
    }
    ...
    private paginateCourses(data: ICourseManage[], headers: HttpHeaders) {
