...
export class TeacherManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.teacherService
            ...
            .subscribe(
                (res: HttpResponse<ITeacherManage[]>) => this.paginateTeachers(res.body, res.headers),
    ...
    trackId(index: number, item: ITeacherManage) {
        return item.id;
    }
    ...
    private paginateTeachers(data: ITeacherManage[], headers: HttpHeaders) {
