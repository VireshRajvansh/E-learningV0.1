...
export class ServicesManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.servicesService
            ...
            .subscribe(
                (res: HttpResponse<IServicesManage[]>) => this.paginateServices(res.body, res.headers),
    ...
    trackId(index: number, item: IServicesManage) {
        return item.id;
    }
    ...
    private paginateServices(data: IServicesManage[], headers: HttpHeaders) {
