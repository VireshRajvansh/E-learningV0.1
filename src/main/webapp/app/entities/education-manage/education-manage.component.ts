...
export class EducationManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.educationService
            ...
            .subscribe(
                (res: HttpResponse<IEducationManage[]>) => this.paginateEducations(res.body, res.headers),
    ...
    trackId(index: number, item: IEducationManage) {
        return item.id;
    }
    ...
    private paginateEducations(data: IEducationManage[], headers: HttpHeaders) {
