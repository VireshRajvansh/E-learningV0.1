...
export class JobsManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.jobsService
            ...
            .subscribe(
                (res: HttpResponse<IJobsManage[]>) => this.paginateJobs(res.body, res.headers),
    ...
    trackId(index: number, item: IJobsManage) {
        return item.id;
    }
    ...
    private paginateJobs(data: IJobsManage[], headers: HttpHeaders) {
