...
export class CityManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.cityService
            ...
            .subscribe(
                (res: HttpResponse<ICityManage[]>) => this.paginateCities(res.body, res.headers),
    ...
    trackId(index: number, item: ICityManage) {
        return item.id;
    }
    ...
    private paginateCities(data: ICityManage[], headers: HttpHeaders) {
