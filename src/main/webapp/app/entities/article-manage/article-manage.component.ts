...
export class ArticleManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.articleService
            ...
            .subscribe(
                (res: HttpResponse<IArticleManage[]>) => this.paginateArticles(res.body, res.headers),
    ...
    trackId(index: number, item: IArticleManage) {
        return item.id;
    }
    ...
    private paginateArticles(data: IArticleManage[], headers: HttpHeaders) {
