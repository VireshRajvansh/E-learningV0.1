...
export class QuizManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.quizService
            ...
            .subscribe(
                (res: HttpResponse<IQuizManage[]>) => this.paginateQuizzes(res.body, res.headers),
    ...
    trackId(index: number, item: IQuizManage) {
        return item.id;
    }
    ...
    private paginateQuizzes(data: IQuizManage[], headers: HttpHeaders) {
