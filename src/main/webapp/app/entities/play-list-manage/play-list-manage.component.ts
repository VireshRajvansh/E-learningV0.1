...
export class PlayListManageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.playListService
            ...
            .subscribe(
                (res: HttpResponse<IPlayListManage[]>) => this.paginatePlayLists(res.body, res.headers),
    ...
    trackId(index: number, item: IPlayListManage) {
        return item.id;
    }
    ...
    private paginatePlayLists(data: IPlayListManage[], headers: HttpHeaders) {
